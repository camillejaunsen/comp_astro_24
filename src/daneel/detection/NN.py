...
if __name__ == "__main__":
    train_dataset_path = "/Users/camillejaunsen/Documents/Computational_astrophysics/group_comp_astro_24/data_injected/exoTrain.csv"
    dev_dataset_path = "/Users/camillejaunsen/Documents/Computational_astrophysics/group_comp_astro_24/data_injected/exoTest.csv"
    ...
    precision_train = precision_score(Y_train, train_outputs, average='micro') ##La til micro
    precision_dev = precision_score(Y_dev, dev_outputs, average='micro')
    recall_train = recall_score(Y_train, train_outputs, average='micro')
    recall_dev = recall_score(Y_dev, dev_outputs, average='micro')
